...
if($ssh->system('apt-get install --force-yes sox libparallel-iterator-perl libmodule-depends-perl cpanminus git libfile-homedir-perl libmoo-perl libmoose-perl liblog-any-adapter-perl liblog-any-perl build-essential libdpkg-perl libapt-pkg-perl')){
