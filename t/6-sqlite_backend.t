...
is( scalar( $Backend->get_all_rooms),
    1, "One room" );
is( ( $Backend->search_room("bed") )[0]->name,
    "bedroom", "Searching room name" );
is( ( $Backend->get_all_gpio() )[0]->type,
    3, "Get first gpio type" );
is( ( $Backend->get_all_gpio() )[1]->type,
    1, "Get second gpio type" );
is( ( $Backend->get_all_gpio() )[1]->value,
    1, "Get second gpio value" );
is( scalar( $Backend->get_all_gpio),
    2, "Two GPIOs" );
